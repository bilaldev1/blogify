...
import { Container, ButtonTeal, Input } from "../components";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Unlock a world of insightful posts! Sign up now to start exploring."
        />
        ...
        <Container className="flex flex-col items-center">
          <div className="flex flex-col items-center gap-4 bg-gray-800 p-10 rounded-xl">
            ...
            <form
              ...
              className="relative pt-3 w-full max-w-[22.5rem] flex flex-col gap-5"
            >
              <Input
                type="text"
              ...
              <ButtonTeal type="submit">Sign Up</ButtonTeal>
            </form>
          </div>
        </Container>
      </div>
