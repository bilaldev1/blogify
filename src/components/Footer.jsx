...
function Footer() {
  return (
    <footer className="w-full">
      <Container className="py-4 flex justify-between items-center h-full border-dashed border-gray-500 border-t">
        <p>©2024 Blogify - Created By Mohammad Bilal Mansuri</p>
